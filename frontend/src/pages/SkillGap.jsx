        ...
        {!analysisResult ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-10 text-left">
            <div className="mb-8 text-center max-w-2xl mx-auto">
              ...
              <p className="text-gray-600">
                Compare your current resume against a target job description to
                discover missing skills, get a personalized learning roadmap,
                and see what you can add right now.
              </p>
            </div>
            ...
            <div className="space-y-8 max-w-3xl mx-auto">
              ...
              {inputMode === "existing" && (
                <div className="space-y-3">
                  <label className="block text-sm font-bold text-gray-700 flex items-center gap-2">
                    <FileText size={18} className="text-violet-500" /> 1. Select
                    Your Resume
                  </label>
                  {fetchingResumes ? (
                  ...
                  {selectedResume && (
                    <div className="p-3 bg-blue-50 border border-blue-100 rounded-lg mt-2 flex flex-wrap gap-2">
                      <span className="text-xs font-semibold text-blue-800 uppercase w-full mb-1">
                        Current Skills on Resume:
                      </span>
                      {selectedResume.skills?.map((s, i) => (
                        <span
                          key={i}
                          className="text-xs bg-white text-blue-700 border border-blue-200 px-2 py-1 rounded-md"
                        >
                          {s.name}
                        </span>
                      ))}
              ...
              {inputMode === "upload" && (
                <div className="space-y-3">
                  <label className="block text-sm font-bold text-gray-700 flex items-center gap-2">
                    <Upload size={18} className="text-violet-500" /> 1. Upload
              ...
              <div className="space-y-3">
                <label className="block text-sm font-bold text-gray-700 flex items-center gap-2">
                  <Target size={18} className="text-violet-500" /> 2. Paste
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <ResumeSuggestions
                suggestions={analysisResult.resumeSuggestions}
                resumeId={inputMode === "existing" ? selectedResumeId : null}
              />
            </div>
