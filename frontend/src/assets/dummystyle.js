...
export const dashboardStyles = {
  ...
  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200 mr-5",
  ...
  // Empty State
  emptyStateWrapper: "flex flex-col items-center justify-center py-12 text-center gap-2 space-y-2",
...
export const cardStyles = {
  ...
  previewArea: "p-4 sm:p-6 flex-1 relative overflow-hidden min-h-[220px]",
  ...
  templateOverlay: "absolute inset-0 bg-black/10 flex items-center justify-center",
...
export const certificationInfoStyles = {
  ...
  heading: "text-2xl font-black text-slate-900 mb-8 text-left w-full",
...
export const projectDetailStyles = {
  ...
  textarea: "w-full p-4 bg-white border border-cyan-200 rounded-xl focus:border-cyan-400 focus:ring-4 focus:ring-cyan-50 transition-all outline-none resize-none text-left",
...
export const workExperienceStyles = {
  ...
  textarea: "w-full p-4 bg-white border border-green-200 rounded-xl focus:border-green-400 focus:ring-4 focus:ring-green-50 transition-all outline-none resize-none text-left",
